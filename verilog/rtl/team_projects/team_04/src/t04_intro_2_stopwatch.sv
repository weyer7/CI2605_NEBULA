...
//button syncs
t04_synch_edge_det sync_one (.clk(clk), .n_rst(n_rst), .async_in(BTN[0]), .edge_flag(one_button_sync));
t04_synch_edge_det sync_ten (.clk(clk), .n_rst(n_rst), .async_in(BTN[1]), .edge_flag(ten_button_sync));
t04_synch_edge_det sync_pause (.clk(clk), .n_rst(n_rst), .async_in(BTN[2]), .edge_flag(pause_sync));
t04_synch_edge_det sync_clear (.clk(clk), .n_rst(n_rst), .async_in(BTN[3]), .edge_flag(clear_sync));
