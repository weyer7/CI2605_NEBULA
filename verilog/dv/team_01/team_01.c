...
#include <defs.h>
#include <stub.c>
// #include "team_01_cpu.h"  // Uncomment if you're a CPU team and need to load instructions to RAM
...
void main()
{
	...
	*/
	...
	// ****************************************
	// PLL Configuration (Configure to 25 MHz)
	// ****************************************

	// Set PLL enable, no DCO mode
    reg_hkspi_pll_ena = 0x1;

	// Set both PLL output dividers to 6
    reg_hkspi_pll_source = 0x36;

	// Write 15 to feedback divider
