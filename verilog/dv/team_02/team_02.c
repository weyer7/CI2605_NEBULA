...
#include <defs.h>
#include <stub.c>
// #include "team_02_cpu.h"  // Uncomment if you're a CPU team and need to load instructions to RAM

// List of Wishbone Slave Addresses

// Change this to 300X0000 where X is your team number
#define reg_team_02_EN (*(volatile uint32_t*)0x30020000)
...
void main()
{
	...
	*/
	...
	reg_mprj_io_5 = GPIO_MODE_USER_STD_INPUT_NOPULL;	// IMU Enable
    reg_mprj_io_6 = GPIO_MODE_USER_STD_INPUT_NOPULL;	// Serial Data Out from IMU
    reg_mprj_io_7 = GPIO_MODE_USER_STD_OUTPUT;			// CS into IMU
    reg_mprj_io_8 = GPIO_MODE_USER_STD_OUTPUT;			// Serial Data Into IMU
    reg_mprj_io_9 = GPIO_MODE_USER_STD_OUTPUT;			// SCLK into IMU
    reg_mprj_io_10 = GPIO_MODE_USER_STD_INPUT_NOPULL;	// SDI from shift register
    reg_mprj_io_11 = GPIO_MODE_USER_STD_OUTPUT;			// SCLK into shift register
    reg_mprj_io_12 = GPIO_MODE_USER_STD_OUTPUT;			// Latch for shift register
    reg_mprj_io_13 = GPIO_MODE_USER_STD_OUTPUT;			// PWM X out
    reg_mprj_io_14 = GPIO_MODE_USER_STD_OUTPUT;			// PWM Y out
    reg_mprj_io_15 = GPIO_MODE_USER_STD_OUTPUT;			// CS into LCD
    reg_mprj_io_16 = GPIO_MODE_USER_STD_OUTPUT;			// SDO into LCD
    reg_mprj_io_17 = GPIO_MODE_USER_STD_OUTPUT;			// SCLK into SSD
	...
	// ****************************************
	// NOTE: Design operates at 10 MHz
	// ****************************************
