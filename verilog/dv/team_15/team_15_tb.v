...
module team_15_tb;
	...
	initial begin
		$dumpfile("team_15.vcd");
		$dumpvars(0, team_15_tb.mprj_io, team_15_tb.uut.chip_core.mprj);
		...
		$display("%c[1;31m",27);
		`ifdef GL
			$display ("Monitor: Timeout, NEBULA Team 15 (GL) Failed");
		`else
			$display ("Monitor: Timeout, NEBULA Team 15 (RTL) Failed");
		`endif
		$display("%c[0m",27);
		$finish;
	end
	...
	initial begin
		...
		$display("%c[1;32m",27);
		`ifdef GL
	    	$display("Monitor: NEBULA Team 15 (GL) Passed");
		`else
		    $display("Monitor: NEBULA Team 15 (RTL) Passed");
		`endif
		$display("%c[0m",27);
	    $finish;
	end
